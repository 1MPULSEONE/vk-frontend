...
const badgeVariants = cva(
  "flex flex-row inline-flex items-center justify-center rounded-full relative font-500 max-min-w-fit",
  {
    variants: {
      variant: {
      ...
      size: {
        8: "h-[8px] w-[8px] text-[4px] text-[0rem]",
        12: "h-[12px] w-[12px] text-[6px] text-[0rem]",
        16: "h-[16px] w-[16px] text-[8px] px-1 text-11",
        20: "h-[20px] w-[20px] text-[10px] px-1 text-13",
        24: "h-[24px] w-[24px] text-[12px] px-2 text-15",
      },
      stroke: {
